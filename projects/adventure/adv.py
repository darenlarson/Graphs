...
#     # Create a set to store verticies (rooms)
#     visited = set()

#     # Create a traversalPath that will be returned
#     traversalPath = []

#     # Put the starting vertex (room) in the stack
#     s.push(world.startingRoom.id) # Not sure if this is really the starting vertex!?!?
#     print("stack:", s.stack)

#     # While the stack is not empty:
#     while s.size() > 0:
#         print("---------ITERATING WHILE LOOP---------")
#         print("stack:", s.stack)
#         # Pop the top vertex (room) from the stack
#         v = s.pop()
#         print("stack:", s.stack)
#         print("v:", v)

#         player.currentRoom = v
#         print("player.currentRoom")

#         # If that vertex (room) hasn't been visited:
#         if v not in visited:
#             # Mark it as visited
#             visited.add(v)

#             # Add all of the verts (rooms) connected to this room
#             # Possible directions to loop over
#             directions = ['n', 'e', 's', 'w']
#             for direction in directions:
#                 print("---------ITERATING FOR LOOP---------")
#                 # Save in a variable the room that is in the direction
#                 next_room = player.currentRoom.getRoomInDirection(direction)
#                 print(next_room.id)

#                 # If next room given direction is not none and has not been visited add it to the Stack
...
# PROVIDED CODE, UNCOMMENT LATER - DAREN LARSON
# TRAVERSAL TEST
# visited_rooms = set()
